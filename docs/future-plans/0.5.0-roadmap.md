...
> **Status:** In progress — durability and disaster recovery focus
...
### Remaining 0.5.0 scope (durability and safety)

| # | Feature | Breaking? | Effort | Status | Tasks |
|---|---------|-----------|--------|--------|-------|
| 5 | [Crash-recovery position collision](#5-crash-recovery-position-collision) | No | Medium | 🔲 Not started | [Tasks](../releases/0.5.0-crash-recovery-tasks.md) |
| 6 | [Corrupt-ledger silent reset](#6-corrupt-ledger-silent-reset) | No | Small | 🔲 Not started | [Tasks](../releases/0.5.0-corrupt-ledger-tasks.md) |
| 9 | [`LogReadError` nullable guard](#9-logreaderr-nullable-storename) | No | Trivial | 🔲 Not started | [Tasks](../releases/0.5.0-log-read-error-tasks.md) |
