...
| 6 | **Extract `TagIndex`/`EventTypeIndex` duplication** | Pure internal refactor. No longer blocked on multi-context — can be done independently. No public API impact. | ⬜ Pending |
